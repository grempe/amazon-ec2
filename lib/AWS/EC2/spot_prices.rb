  ...
  module EC2
    ...
    class Base < AWS::Base
      ...
      def describe_spot_price_history( options = {} )
        ...
        raise ArgumentError, ":instance_type must specify a valid instance type" unless options[:instance_type].nil? || ["t1.micro", "m1.small", "m1.large", "m1.xlarge", "m2.xlarge", "c1.medium", "c1.xlarge", "m2.2xlarge", "m2.4xlarge", "cc1.4xlarge", "cc2.8xlarge", "cg1.4xlarge"].include?(options[:instance_type])
