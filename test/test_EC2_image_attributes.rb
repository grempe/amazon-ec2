...
context "EC2 image_attributes " do
  ...
  specify "should raise an exception when modify_image_attribute is called with incorrect arguments" do
    ...
    lambda { @ec2.modify_image_attribute() }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"") }.should.raise(AWSAPI::ArgumentError)

    # :image_id option must be not be empty or nil
    lambda { @ec2.modify_image_attribute(:image_id=>nil, :attribute=>"launchPermission", :operation_type=>"add", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"", :attribute=>"launchPermission", :operation_type=>"add", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
    ...
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>nil, :operation_type=>"add", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"", :operation_type=>"add", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"foo", :operation_type=>"add", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)

    # :attribute => 'launchPermission' option should fail if neither :group nor :user_id are also provided
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"add") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"add", :group => nil) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"add", :group => "") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"add", :user_id => nil) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"add", :user_id => "") }.should.raise(AWSAPI::ArgumentError)

    # :attribute => 'productCodes' option should fail if :product_code isn't also provided
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"productCodes", :product_code=>nil) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"productCodes", :product_code=>"") }.should.raise(AWSAPI::ArgumentError)

    # :operation_type currently has two options which are 'add' and 'remove', and it should fail with any other, nil or empty
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>nil, :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.modify_image_attribute(:image_id=>"ami-61a54008", :attribute=>"launchPermission", :operation_type=>"foo", :group=>["all"]) }.should.raise(AWSAPI::ArgumentError)
  end
  ...
  specify "should raise an exception when describe_image_attribute is called with incorrect arguments" do
    # method args can't be nil or empty
    lambda { @ec2.describe_image_attribute() }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.describe_image_attribute(:image_id=>"") }.should.raise(AWSAPI::ArgumentError)

    # :image_id option must be not be empty or nil w/ launchPermission
    lambda { @ec2.describe_image_attribute(:image_id=>nil, :attribute=>"launchPermission") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.describe_image_attribute(:image_id=>"", :attribute=>"launchPermission") }.should.raise(AWSAPI::ArgumentError)

    # :image_id option must be not be empty or nil w/ productCodes
    lambda { @ec2.describe_image_attribute(:image_id=>nil, :attribute=>"productCodes") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.describe_image_attribute(:image_id=>"", :attribute=>"productCodes") }.should.raise(AWSAPI::ArgumentError)

    # :attribute currently has two options which are 'launchPermission' and 'productCodes', it should fail with any other values,
    # nil, or empty
    lambda { @ec2.describe_image_attribute(:image_id=>"ami-61a54008", :attribute=>nil) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.describe_image_attribute(:image_id=>"ami-61a54008", :attribute=>"") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.describe_image_attribute(:image_id=>"ami-61a54008", :attribute=>"foo") }.should.raise(AWSAPI::ArgumentError)
  end
  ...
  specify "should raise an exception when reset_image_attribute is called with incorrect arguments" do
    # method args can't be nil or empty
    lambda { @ec2.reset_image_attribute() }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.reset_image_attribute(:image_id=>"") }.should.raise(AWSAPI::ArgumentError)

    # :image_id option must be not be empty or nil
    lambda { @ec2.reset_image_attribute(:image_id=>nil, :attribute=>"launchPermission") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.reset_image_attribute(:image_id=>"", :attribute=>"launchPermission") }.should.raise(AWSAPI::ArgumentError)

    # :attribute currently has one option which is 'launchPermission', it should fail with any other value, nil, or empty
    lambda { @ec2.reset_image_attribute(:image_id=>"ami-61a54008", :attribute=>nil) }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.reset_image_attribute(:image_id=>"ami-61a54008", :attribute=>"") }.should.raise(AWSAPI::ArgumentError)
    lambda { @ec2.reset_image_attribute(:image_id=>"ami-61a54008", :attribute=>"foo") }.should.raise(AWSAPI::ArgumentError)
  end
